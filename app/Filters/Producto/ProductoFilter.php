...
class ProductoFilter
{
    ...
    {
        return $query
            ->when($filters['categorias'] ?? null, function ($query, $categoriaId) {
            ...
            ->when(
                array_key_exists('agotado', $filters) && $filters['agotado'] !== null && $filters['agotado'] !== '',
                function ($query) use ($filters) {
                    $agotado = filter_var($filters['agotado'], FILTER_VALIDATE_BOOLEAN);
                    if ($agotado) {
